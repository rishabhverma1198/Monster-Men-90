  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen">
        ...
        <SidebarInset>
          <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background px-6 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-12">
